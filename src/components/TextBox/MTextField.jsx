      ...
      render={({ field, fieldState }) => (
        <>
          {description && description.align === "Top" && (
            <Typography style={description.style}>
              {description.text}
            </Typography>
          )}
          {labelType === "Normal" && (
          ...
          {description && description.align === "Bottom" && (
            <Typography
              ...
              className={
                description?.className ? description?.className : undefined
              }
            >
              {description.text}
            </Typography>
          ...
          <TextField
            ...
            slotProps={{
              htmlInput: {
                ...
                minLength,
                inputMode:
                  type === TextType.Currency || type === TextType.Number
                    ? "decimal"
                    : "text",
                readOnly: readonly,
              ...
              input: {
                startAdornment: startSuffix ? (
                  <InputAdornment position="end" className="suffixAdornment">
                    {startSuffix}
                  </InputAdornment>
                ) : type === TextType.Currency && currency ? (
                ...
                inputComponent: mask
                  ...
                  : type === TextType.Currency
                    ? NumericFormatCustom
                    : undefined, // Choose the right component
              },
            }}
            onChange={(e) => {
              const upperValue = isCapital
