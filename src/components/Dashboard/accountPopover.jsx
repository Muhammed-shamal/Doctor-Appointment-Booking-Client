...
import photo from '../../assets/logos/logo1.png'
...
export default function AccountPopover() {
  ...
  const handleLogout = async () => {
    try {
      ...
      Toast(error.response?.data?.message || 'Logout failed. Please try again!', 'error');
      handleClose();
    }
  }
  ...
  return (
    <>
      ...
      >
        ...
        {/* <Avatar src={photo} alt={account.displayName} /> */}
          <Box
        sx={{
          height: 60,
          display: "flex",
