...
// export interface WSLoadingOverlayProps {
//   /** Loading state */
//   loading: boolean;
...
//   /** Variant of loader */
//   variant?: 'circular' | 'linear' | 'dots' | 'spinner' | 'pulse';
...
//   /** Show progress percentage (only for linear) */
...
//   /** Custom content to show inside loader */
...
// const WSLoadingOverlay: React.FC<WSLoadingOverlayProps> = ({
//   loading,
//   message = 'Loading...',
//   variant = 'circular',
//   size = 'medium',
...
// export const WSFullScreenLoader: React.FC<{ loading: boolean; message?: string }> = ({
//   loading,
//   message = 'Loading...',
// }) => (
//   <WSLoadingOverlay
...
// export const WSButtonLoader: React.FC<{ loading: boolean; size?: 'small' | 'medium' | 'large' }> = ({
//   loading,
//   size = 'small',
// }) => (
//   <WSLoadingOverlay
...
// export const WSProgressLoader: React.FC<{ 
//   loading: boolean; 
//   progress: number; 
//   message?: string;
//   determinate?: boolean;
// }> = ({ loading, progress, message = 'Uploading...', determinate = true }) => (
//   <WSLoadingOverlay
//     loading={loading}
//     message={message}
//     variant="linear"
...
// export const WSPageLoader: React.FC<{ loading: boolean; message?: string }> = ({
//   loading,
...
// export default WSLoadingOverlay;